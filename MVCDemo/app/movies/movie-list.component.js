...
var MovieListComponent = (function () {
    ...
    MovieListComponent.prototype.onDeleting = function (id) {
        this._movieService.deleteMovie(id).subscribe(function (movie) {
            console.log(movie);
        });
    };
    MovieListComponent.prototype.onGettingMovieEvents = function (id) {
        var _this = this;
        this._movieService.getMovieEvents(id).subscribe(function (movieEvents) {
            console.log(movieEvents);
            _this.movieEvents = movieEvents;
        });
    };
